function Emitter(domContainer){
	...
	this.makeExplosion=function(xpos,ypos,zpos){
		for (var i = 0; i < 30; i++) {
			...
			var speed=Math.sqrt((particle.xVel*particle.xVel)+
...
function Particle(){
	...
	domElement.style.background='url(img/orangeParticle.png) transparent';
	
	domElement.style.position='absolute';
	domElement.style.display='block';
	domElement.style.width='32px';
	domElement.style.height='32px';
	/*var trano=(domElement.style.webkitTransformOrigin
	||domElement.style.MozTransformOrigin
	||domElement.style.oTransformOrigin
	||domElement.style.msTransformOrigin);
	trano='16px 16px';*/
	...
	this.update=function(){
		...
		/*var tranf=(domElement.style.webkitTransform
		||domElement.style.MozTransform
		||domElement.style.oTransform
		||domElement.style.msTransform);
		tranf='translate3d('+this.x+'px, '+this.y+'px, '+this.z+'px) scale('+this.size+')';*/
